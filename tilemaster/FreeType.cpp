...
///with freetype fonts.
void print(const font_data &ft_font, float x, float y,bool picture, GLuint pic, GameAPI_Color clrFrom, GameAPI_Color clrTo, const char *fmt, ...)  {
 ...
 glBegin(GL_QUADS); 
    ...
    glColor3f(clrFrom.r,clrFrom.g,clrFrom.b);				
    glVertex3f(x-20,y-20, 0);
    glVertex3f(x + sz, y-20, 0);
    glColor3f(clrTo.r,clrTo.g,clrTo.b);				
    glVertex3f(x + sz, y + 50, 0);
